...
namespace ShowroomManagement.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        [AllowAnonymous]
        public Task<IActionResult> Login([Bind("username,password")] Account accountLogin)
        {
            Account? user = Authenticate(accountLogin);
        ...
        private string Generate(Account account)
        {
            ...
            var claims = new[]
            {
                ...
                new Claim(ClaimTypes.Role, Convert.ToString(account.Level))
            };
