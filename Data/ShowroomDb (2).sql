...
VALUES 
    (N'E001', 'john_doe2', CONVERT(VARBINARY(500), 'password1'), 0, GETDATE(), NULL),
    (N'E002', 'jane_smith', CONVERT(VARBINARY(500), 'password2'), 0, GETDATE(), NULL),
    (N'E003', 'bob_jones', CONVERT(VARBINARY(500), 'password3'), 0, GETDATE(), NULL),
    (N'E004', 'susan_wilson', CONVERT(VARBINARY(500), 'password4'), 0, GETDATE(), NULL),
    (N'E005', 'mike_adams', CONVERT(VARBINARY(500), 'password5'), 0, GETDATE(), NULL),
    (N'E006', 'lisa_miller', CONVERT(VARBINARY(500), 'password6'), 0, GETDATE(), NULL),
    (N'E007', 'david_brown', CONVERT(VARBINARY(500), 'password7'), 0, GETDATE(), NULL),
    (N'E008', 'emily_white', CONVERT(VARBINARY(500), 'password8'), 0, GETDATE(), NULL),
    (N'E009', 'steve_green', CONVERT(VARBINARY(500), 'password9'), 0, GETDATE(), NULL),
    (N'E010', 'jennifer_black', CONVERT(VARBINARY(500), 'password10'), 0, GETDATE(), NULL);
