...
BEGIN
    UPDATE s
    set Total =Total + i.QuantitySale* p.SalePrice
    from SalesTargets as s 
    JOIN inserted AS i on i.SaleId = s.SaleId
...
--- ### SALE INVOICES 
INSERT INTO SalesInvoices (InSaleId, ClientId,SaleId, ProductId, Date, QuantitySale, Status,Deleted)
VALUES
    (N'IS001', N'C001',N'E001', N'P001', '2023-01-15', 3, N'Đã bán hàng',0),
    (N'IS002', N'C002',N'E002', N'P002', '2023-02-20', 6, N'Đã bán hàng',0),
    (N'IS003', N'C003',N'E003', N'P003', '2023-03-25', 4, N'Đã bán hàng',0),
    (N'IS004', N'C004',N'E004', N'P004', '2023-04-30', 8, N'Đã bán hàng',0),
    (N'IS005', N'C005',N'E005', N'P005', '2023-05-05', 10, N'Đã bán hàng',0),
    (N'IS006', N'C006',N'E006', N'P006', '2023-06-10', 5, N'Đã bán hàng',0),
    (N'IS007', N'C007',N'E007', N'P007', '2023-07-15', 7, N'Đã bán hàng',0),
    (N'IS008', N'C008',N'E008', N'P008', '2023-08-20', 9, N'Đã bán hàng',0),
    (N'IS009', N'C009',N'E009', N'P009', '2023-09-25', 2, N'Đã bán hàng',0),
    (N'IS010', N'C010',N'E010', N'P010', '2023-10-30', 12, N'Đã bán hàng',0);
