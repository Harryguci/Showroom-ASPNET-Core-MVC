...
VALUES
    (N'Toyota Camry', N'P001', 28000, 35000, 5, N'Available'),
    (N'Honda Civic', N'P002', 25000, 32000, 3, N'Available'),
    (N'Ford Mustang', N'P003', 35000, 42000, 2, N'Available'),
    (N'Chevrolet Silverado', N'P004', 32000, 39000, 4, N'Available'),
    (N'Audi Q5', N'P005', 42000, 49000, 3, N'Available'),
    (N'Mercedes-Benz E-Class', N'P006', 45000, 52000, 2, N'Available'),
    (N'BMW X5', N'P007', 48000, 55000, 3, N'Available'),
    (N'Tesla Model 3', N'P008', 50000, 58000, 2, N'Available'),
    (N'Nissan Altima', N'P009', 27000, 34000, 4, N'Available'),
    (N'Kia Optima', N'P010', 24000, 31000, 3, N'Available');
...
VALUES
    (N'IS001', N'C001', N'P001', '2022-01-15', 3, N'Đã bán hàng'),
    (N'IS002', N'C002', N'P002', '2022-02-20', 6, N'Đã bán hàng'),
    (N'IS003', N'C003', N'P003', '2022-03-25', 4, N'Đã bán hàng'),
    (N'IS004', N'C004', N'P004', '2022-04-30', 8, N'Đã bán hàng'),
    (N'IS005', N'C005', N'P005', '2022-05-05', 10, N'Đã bán hàng'),
    (N'IS006', N'C006', N'P006', '2022-06-10', 5, N'Đã bán hàng'),
    (N'IS007', N'C007', N'P007', '2022-07-15', 7, N'Đã bán hàng'),
    (N'IS008', N'C008', N'P008', '2022-08-20', 9, N'Đã bán hàng'),
    (N'IS009', N'C009', N'P009', '2022-09-25', 2, N'Đã bán hàng'),
    (N'IS010', N'C010', N'P010', '2022-10-30', 12, N'Đã bán hàng');

---### SALE TARGET 
INSERT INTO SalesTargets (SaleId, StartDate, EndDate, Total, Target, Status, Reward)
VALUES
    (N'S001', '2022-01-01', '2022-12-31', 220, 200, N'In Progress', 0.03),
    (N'S002', '2022-02-01', '2022-12-31', 230, 180, N'In Progress', 0.03),
    (N'S003', '2022-03-01', '2022-12-31', 180, 220, N'In Progress', 0.03),
    (N'S004', '2022-04-01', '2022-12-31', 160, 210, N'In Progress', 0.03),
    (N'S005', '2022-05-01', '2022-12-31', 190, 230, N'In Progress', 0.03),
    (N'S006', '2022-06-01', '2022-12-31', 140, 190, N'In Progress', 0.03),
    (N'S007', '2022-07-01', '2022-12-31', 130, 180, N'In Progress', 0.03),
    (N'S008', '2022-08-01', '2022-12-31', 170, 220, N'In Progress', 0.03),
    (N'S009', '2022-09-01', '2022-12-31', 155, 200, N'In Progress', 0.03),
    (N'S010', '2022-10-01', '2022-12-31', 145, 190, N'In Progress', 0.03);

---### DEVICES 
INSERT INTO Devices (DeviceId, Name, DateEntry, Price, Status)
VALUES
    (N'D001', N'Hệ thống định vị', '2022-01-05', 500, N'Có sẵn'),
    (N'D002', N'Cảm biến đỗ xe', '2022-02-10', 300, N'Có sẵn'),
    (N'D003', N'Camera lùi', '2022-03-15', 400, N'Có sẵn'),
    (N'D004', N'Cửa sổ trời', '2022-04-20', 600, N'Có sẵn'),
    (N'D005', N'Kết nối Bluetooth', '2022-05-25', 200, N'Có sẵn'),
    (N'D006', N'Cửa số không khóa', '2022-06-30', 250, N'Có sẵn'),
    (N'D007', N'Ghế nóng', '2022-07-05', 350, N'Có sẵn'),
    (N'D008', N'Camera lùi phía sau', '2022-08-10', 400, N'Có sẵn'),
    (N'D009', N'Hệ thống cảnh báo điểm mù', '2022-09-15', 450, N'Có sẵn'),
    (N'D010', N'Tích hợp điện thoại thông minh', '2022-10-20', 300, N'Có sẵn');
...
VALUES
    (N'TD001', N'E001', N'C001', '2022-01-15', N'Lên lịch lái thử cho khách hàng', N'Đã lên lịch'),
    (N'TD002', N'E002', N'C002', '2022-02-20', N'Lên lịch lái thử cho khách hàng', N'Đã lên lịch'),
    (N'TD003', N'E003', N'C003', '2022-03-25', N'Lên lịch lái thử cho khách hàng', N'Đã lên lịch'),
    (N'TD004', N'E004', N'C004', '2022-04-30', N'Lên lịch lái thử cho khách hàng', N'Đã lên lịch'),
    (N'TD005', N'E005', N'C005', '2022-05-05', N'Lên lịch lái thử cho khách hàng', N'Đã lên lịch'),
    (N'TD006', N'E006', N'C006', '2022-06-10', N'Lên lịch lái thử cho khách hàng', N'Đã lên lịch'),
    (N'TD007', N'E007', N'C007', '2022-07-15', N'Lên lịch lái thử cho khách hàng', N'Đã lên lịch'),
    (N'TD008', N'E008', N'C008', '2022-08-20', N'Lên lịch lái thử cho khách hàng', N'Đã lên lịch'),
    (N'TD009', N'E009', N'C009', '2022-09-25', N'Lên lịch lái thử cho khách hàng', N'Đã lên lịch'),
    (N'TD010', N'E010', N'C010', '2022-10-30', N'Lên lịch lái thử cho khách hàng', N'Đã lên lịch');


---### ACCOUNT 
INSERT INTO Account (EmployeeId, Username, Password_foruser, Deleted, CreateAt, DeleteAt)
VALUES 
    ('E001', 'john_doe2', CONVERT(VARBINARY(500), 'password1'), 0, GETDATE(), NULL),
    ('E002', 'jane_smith', CONVERT(VARBINARY(500), 'password2'), 0, GETDATE(), NULL),
    ('E003', 'bob_jones', CONVERT(VARBINARY(500), 'password3'), 0, GETDATE(), NULL),
    ('E004', 'susan_wilson', CONVERT(VARBINARY(500), 'password4'), 0, GETDATE(), NULL),
    ('E005', 'mike_adams', CONVERT(VARBINARY(500), 'password5'), 0, GETDATE(), NULL),
    ('E006', 'lisa_miller', CONVERT(VARBINARY(500), 'password6'), 0, GETDATE(), NULL),
    ('E007', 'david_brown', CONVERT(VARBINARY(500), 'password7'), 0, GETDATE(), NULL),
    ('E008', 'emily_white', CONVERT(VARBINARY(500), 'password8'), 0, GETDATE(), NULL),
    ('E009', 'steve_green', CONVERT(VARBINARY(500), 'password9'), 0, GETDATE(), NULL),
    ('E010', 'jennifer_black', CONVERT(VARBINARY(500), 'password10'), 0, GETDATE(), NULL);
